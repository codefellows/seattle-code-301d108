...
1. Create a new branch for this challenge called `regex`
...
1. You'll see a series of challenges in the `challenges-13.test.js` file each of which has an associated test at the bottom of the file.
