# Code Challenge: Object Deconstruction
...
For a quick overview, wath this [YouTube video](https://www.youtube.com/watch?v=-vR3a11Wzt0){:target="_blank"} that describes object deconstruction at an introductory level.
...
1. Create a new branch for this challenge called `object-spread`
   - `git checkout -b object-spread`
...
1. You'll see a series of challenges in the `challenges-04.test.js` file each of which has an associated test at the bottom of the file.
